...
<div class="content">
    ...
    <!-- Sequence Summary - got this info from the log.txt file produced - hard-coded because im too scared to ruin the code -->
    ...
    <div class="result-section">
        ...
        <img src="data/job_13/histogram.png" alt="Sequence length histogram" class="result-img">
        <div class="bio-note">
    ...
    <div class="result-section">
        ...
        <img src="data/job_13/conservation.1.png" alt="Conservation plot" class="result-img">
        <div class="bio-note">
        ...
        <p style="margin-top:12px;">
            <a href="data/job_13/aligned.fasta" download>Download aligned FASTA</a>
        </p>
    </div>

    <hr>

    <!-- motifs - from .txt file stored server-side - also hard-coded (same reasoning)-->
    <div class="result-section">
       <h3>PROSITE Motif Scan <span class="badge badge-complete">Complete</span></h3>
       <table>
           <tr><th>Accession</th><th>Species</th><th>Motif</th><th>Start</th><th>End</th></tr>
           <?php
           $motifs = [
               ['KAN1727817.1','Threskiornis aethiopicus','AMIDATION',139,142],
               ['KAJ7421106.1','Willisornis vidua','AMIDATION',139,142],
               ['KAJ7396366.1','Pitangus sulphuratus','AMIDATION',139,142],
               ['KAI6072612.1','Aix galericulata','AMIDATION',139,142],
               ['XP_040473657.1','Falco naumanni','AMIDATION',139,142],
               ['XP_040392851.1','Cygnus olor','AMIDATION',139,142],
               ['XP_010411101.1','Corvus cornix cornix','AMIDATION',139,142],
               ['XP_027601652.2','Pipra filicauda','AMIDATION',139,142],
               ['XP_037266979.1','Falco rusticolus','AMIDATION',139,142],
               ['KAF4787459.1','Turdus rufiventris','AMIDATION',139,142],
               ['XP_030364364.1','Strigops habroptila','AMIDATION',139,142],
               ['XP_032566992.1','Chiroxiphia lanceolata','AMIDATION',139,142],
               ['XP_015741500.1','Coturnix japonica','AMIDATION',67,70],
               ['KAF1671963.1','Pygoscelis papua','AMIDATION',139,142],
               ['KAF1663616.1','Aptenodytes patagonicus','AMIDATION',139,142],
               ['KAF1642821.1','Eudyptes chrysocome','AMIDATION',139,142],
               ['KAF1627266.1','Eudyptes filholi','AMIDATION',139,142],
               ['KAF1604860.1','Eudyptes chrysolophus','AMIDATION',139,142],
               ['KAF1584371.1','Eudyptes moseleyi','AMIDATION',139,142],
               ['KAF1578265.1','Eudyptes robustus','AMIDATION',139,142],
               ['KAF1561075.1','Eudyptes pachyrhynchus','AMIDATION',139,142],
               ['KAF1548696.1','Eudyptula albosignata','AMIDATION',139,142],
               ['KAF1546409.1','Eudyptula minor','AMIDATION',139,142],
               ['KAF1524284.1','Eudyptes sclateri','AMIDATION',139,142],
               ['KAF1488921.1','Eudyptula minor novaehollandiae','AMIDATION',139,142],
               ['KAF1487788.1','Pygoscelis antarcticus','AMIDATION',139,142],
               ['KAF1473286.1','Megadyptes antipodes antipodes','AMIDATION',139,142],
               ['KAF1471003.1','Megadyptes antipodes antipodes','AMIDATION',139,142],
               ['KAF1464176.1','Megadyptes antipodes antipodes','AMIDATION',139,142],
               ['KAF1464082.1','Megadyptes antipodes antipodes','AMIDATION',139,142],
               ['KAF1459431.1','Spheniscus mendiculus','AMIDATION',139,142],
               ['KAF1440782.1','Spheniscus demersus','AMIDATION',139,142],
               ['KAF1432837.1','Spheniscus magellanicus','AMIDATION',139,142],
               ['KAF1404242.1','Spheniscus humboldti','AMIDATION',139,142],
               ['XP_031990407.1','Corvus moneduloides','AMIDATION',139,142],
               ['XP_019478895.1','Meleagris gallopavo','AMIDATION',1,4],
               ['XP_031456423.1','Phasianus colchicus','AMIDATION',213,216],
               ['XP_030321679.1','Calypte anna','AMIDATION',139,142],
               ['XP_008503927.1','Calypte anna','AMIDATION',139,142],
               ['XP_008922173.2','Manacus vitellinus','AMIDATION',139,142],
               ['XP_027751872.1','Empidonax traillii','AMIDATION',139,142],
               ['XP_027520533.1','Corapipo altera','AMIDATION',139,142],
               ['XP_027558020.1','Neopelma chrysocephalum','AMIDATION',139,142],
               ['XP_026720573.1','Athene cunicularia','AMIDATION',348,351],
               ['XP_026720573.1','Athene cunicularia','AMIDATION',200,203],
           ];
           foreach ($motifs as $m):
           ?>
           <tr>
               <td><?php echo htmlspecialchars($m[0]); ?></td>
               <td><em><?php echo htmlspecialchars($m[1]); ?></em></td>
       ...
       <div class="bio-note">
           PROSITE motif scanning using Patmatmotifs identifies known functional sequence patterns
           within each retrieved protein. The AMIDATION motif was detected at position 139–142 in 
           the majority of sequences, indicating a highly conserved potential amidation site across Aves. 
           Amidation is a common post-translational modification that affects protein stability 
           and biological activity. Its conservation across diverse bird
           species suggests functional importance in glucose-6-phosphatase activity.
       </div>
       <p style="margin-top:12px;">
           <a href="data/job_13/motifs.txt" target="_blank">View raw Patmatmotifs output</a>
       </p>
    </div>
    <hr>
    ...
    <div class="result-section">
        ...
        <?php
        $blast_file = '/home/s2837201/public_html/ICA/data/job_13/blast.txt';
        ...
        <p style="margin-top:12px;">
            <a href="data/job_13/blast.txt" download>Download full BLAST output</a>
        </p>
    </div>
    ...
    <div class="result-section">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            jQuery.ajax({
                url: "/~s2837201/ICA/data/job_13/structure.pdb",
        ...
        <p style="margin-top:12px;">
            <a href="data/job_13/structure.pdb" download>Download PDB file</a>
        </p>
    </div>
    ...
    <div class="result-section">
        ...
        <ul style="margin-left:24px; line-height:2.2;">
            <li><a href="data/job_13/sequences.fasta" download>sequences.fasta</a> - All 50 retrieved sequences</li>
            <li><a href="data/job_13/aligned.fasta" download>aligned.fasta</a> - ClustalOmega alignment</li>
            <li><a href="data/job_13/motifs.txt" download>motifs.txt</a> - Patmatmotifs output</li>
            <li><a href="data/job_13/blast.txt" download>blast.txt</a> - BLAST output</li>
            <li><a href="data/job_13/structure.pdb" download>structure.pdb</a> - ESMFold predicted 3D structure</li>
            <li><a href="data/job_13/log.txt" target="_blank">log.txt</a> - Analysis log</li>
        </ul>
    </div>
