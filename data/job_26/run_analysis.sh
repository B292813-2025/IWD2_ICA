...
# run_analysis.sh — JAHbio job 26

JOB_ID=26
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_26
PROTEIN='cox1'
TAXON='Mammalia'
MAX_SEQS=50
...
search_term = 'cox1[All Fields] AND Mammalia[organism]'
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_26/sequences.fasta'
max_seqs    = 50
...
PYEOF
if [ $? -ne 0 ]; then
    echo 'Biopython failed, trying edirect fallback...'
    SEARCH_TERM="cox1[All Fields] AND Mammalia[organism]"
    esearch -db protein -query "$SEARCH_TERM" | efetch -format fasta > "$FASTA"
    if [ $? -ne 0 ]; then update_status fetch Failed; exit 1; fi
fi

N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_26/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
php $PHP_DIR/update_job.php $JOB_ID $N_SEQS
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_26/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_26/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_26/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_26/histogram.png'
...
fasta    = '/localdisk/home/s2837201/public_html/ICA/data/job_26/sequences.fasta'
out_file = '/localdisk/home/s2837201/public_html/ICA/data/job_26/motifs.txt'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_26/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_26/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_26/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 26 complete.'
