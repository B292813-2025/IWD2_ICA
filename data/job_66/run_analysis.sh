...
# run_analysis.sh — JAHbio job 66

JOB_ID=66
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_66
PROTEIN='cox1'
TAXON='Aves'
MAX_SEQS=20
...
search_term = 'cox1[protein] AND Aves[organism] NOT partial[title]'
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_66/sequences.fasta'
max_seqs    = 20
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_66/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
$DB_UPDATE "UPDATE jobs SET n_returned=$N_SEQS WHERE job_id=$JOB_ID;"
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_66/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_66/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_66/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_66/histogram.png'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_66/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_66/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_66/structure.pdb'
else
    update_status pymol Failed
fi

# ---- ALL DONE ----
echo 'JAHbio job 66 complete.'
