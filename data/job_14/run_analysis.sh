...
# run_analysis.sh — JAHbio job 14

JOB_ID=14
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_14
PROTEIN='kinase'
TAXON='rodentia'
MAX_SEQS=15
...
search_term = 'kinase[All Fields] AND rodentia[organism]'
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_14/sequences.fasta'
max_seqs    = 15
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_14/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
php $PHP_DIR/update_job.php $JOB_ID $N_SEQS
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_14/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_14/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_14/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_14/histogram.png'
...
fasta    = '/localdisk/home/s2837201/public_html/ICA/data/job_14/sequences.fasta'
out_file = '/localdisk/home/s2837201/public_html/ICA/data/job_14/motifs.txt'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_14/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_14/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_14/structure.pdb'
else
    update_status pymol Failed
fi

# ---- ALL DONE ----
echo 'JAHbio job 14 complete.'
