...
# run_analysis.sh — JAHbio job 2

JOB_ID=2
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_2
PROTEIN='kinase'
TAXON='rodents'
MAX_SEQS=50
...
search_term = 'kinase[protein] AND rodents[organism] NOT partial[title]'
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_2/sequences.fasta'
max_seqs    = 50
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_2/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
$DB_UPDATE "UPDATE jobs SET n_returned=$N_SEQS WHERE job_id=$JOB_ID;"
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_2/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_2/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_2/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_2/histogram.png'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_2/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_2/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_2/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 2 complete.'
