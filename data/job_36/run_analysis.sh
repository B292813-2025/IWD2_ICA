...
# run_analysis.sh — JAHbio job 36

JOB_ID=36
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_36
PROTEIN='cox1'
TAXON='Gallus gallus'
MAX_SEQS=20
...
search_term = 'cox1[All Fields] AND Gallus gallus[organism]'
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_36/sequences.fasta'
max_seqs    = 20

tax_handle = Entrez.esearch(db='taxonomy', term='Gallus gallus')
tax_record = Entrez.read(tax_handle)
tax_handle.close()
if tax_record['Count'] == '0':
    print('Taxon not found in NCBI taxonomy: Gallus gallus')
    sys.exit(1)
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_36/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
$DB_UPDATE "UPDATE jobs SET n_returned=$N_SEQS WHERE job_id=$JOB_ID;"
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_36/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_36/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_36/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_36/histogram.png'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_36/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_36/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_36/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 36 complete.'
