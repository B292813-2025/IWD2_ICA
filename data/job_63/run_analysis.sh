...
# run_analysis.sh — JAHbio job 63

JOB_ID=63
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_63
...
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_63/sequences.fasta'
max_seqs    = 50
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_63/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
$DB_UPDATE "UPDATE jobs SET n_returned=$N_SEQS WHERE job_id=$JOB_ID;"
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_63/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_63/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_63/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_63/histogram.png'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_63/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_63/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_63/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 63 complete.'
