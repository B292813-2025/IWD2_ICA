...
# run_analysis.sh — JAHbio job 76

JOB_ID=76
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_76
PROTEIN='cox1'
TAXON='Mammalia'
MAX_SEQS=50
...
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_76/sequences.fasta'
max_seqs    = 50
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_76/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
$DB_UPDATE "UPDATE jobs SET n_returned=$N_SEQS WHERE job_id=$JOB_ID;"
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_76/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_76/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_76/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_76/histogram.png'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_76/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_76/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_76/structure.pdb'
else
    update_status pymol Failed
fi

# ---- ALL DONE ----
echo 'JAHbio job 76 complete.'
