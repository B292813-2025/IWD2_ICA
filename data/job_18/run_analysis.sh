...
# run_analysis.sh — JAHbio job 18

JOB_ID=18
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_18
PROTEIN='cox1'
TAXON='Mammalia'
MAX_SEQS=10
...
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_18/sequences.fasta'
max_seqs    = 10
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_18/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
php $PHP_DIR/update_job.php $JOB_ID $N_SEQS
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_18/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_18/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_18/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_18/histogram.png'
...
fasta    = '/localdisk/home/s2837201/public_html/ICA/data/job_18/sequences.fasta'
out_file = '/localdisk/home/s2837201/public_html/ICA/data/job_18/motifs.txt'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_18/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_18/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_18/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 18 complete.'
