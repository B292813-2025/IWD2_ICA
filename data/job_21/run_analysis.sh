...
# run_analysis.sh — JAHbio job 21

JOB_ID=21
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_21
PROTEIN='cox1'
TAXON='Mammalia'
MAX_SEQS=50
...
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_21/sequences.fasta'
max_seqs    = 50
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_21/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
php $PHP_DIR/update_job.php $JOB_ID $N_SEQS
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_21/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_21/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_21/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_21/histogram.png'
...
fasta    = '/localdisk/home/s2837201/public_html/ICA/data/job_21/sequences.fasta'
out_file = '/localdisk/home/s2837201/public_html/ICA/data/job_21/motifs.txt'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_21/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_21/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_21/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 21 complete.'
