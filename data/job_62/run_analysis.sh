...
# run_analysis.sh — JAHbio job 62

JOB_ID=62
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_62
PROTEIN='COX1'
TAXON='Aves'
MAX_SEQS=50
...
search_term = 'COX1[All Fields] AND Aves[organism]'
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_62/sequences.fasta'
max_seqs    = 50
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_62/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
$DB_UPDATE "UPDATE jobs SET n_returned=$N_SEQS WHERE job_id=$JOB_ID;"
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_62/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_62/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_62/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_62/histogram.png'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_62/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_62/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_62/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 62 complete.'
