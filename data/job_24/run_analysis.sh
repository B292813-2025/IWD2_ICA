...
# run_analysis.sh — JAHbio job 24

JOB_ID=24
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_24
...
search_term = 'glucose-6-phosphatase[protein] AND rodents[organism]'
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_24/sequences.fasta'
max_seqs    = 50

tax_handle = Entrez.esearch(db='taxonomy', term='rodents')
tax_record = Entrez.read(tax_handle)
tax_handle.close()
if tax_record['Count'] == '0':
    print('Taxon not found in NCBI taxonomy: rodents')
    sys.exit(1)
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_24/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
$DB_UPDATE "UPDATE jobs SET n_returned=$N_SEQS WHERE job_id=$JOB_ID;"
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_24/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_24/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_24/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_24/histogram.png'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_24/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_24/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_24/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 24 complete.'
