...
# run_analysis.sh — JAHbio job 32

JOB_ID=32
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_32
PROTEIN='rubisco'
TAXON='arabidopsis'
MAX_SEQS=20
...
search_term = 'rubisco[All Fields] AND arabidopsis[organism]'
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_32/sequences.fasta'
max_seqs    = 20

tax_handle = Entrez.esearch(db='taxonomy', term='arabidopsis')
tax_record = Entrez.read(tax_handle)
tax_handle.close()
if tax_record['Count'] == '0':
    print('Taxon not found in NCBI taxonomy: arabidopsis')
    sys.exit(1)
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_32/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
$DB_UPDATE "UPDATE jobs SET n_returned=$N_SEQS WHERE job_id=$JOB_ID;"
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_32/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_32/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_32/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_32/histogram.png'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_32/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_32/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_32/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 32 complete.'
