...
# run_analysis.sh — JAHbio job 9

JOB_ID=9
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_9
PROTEIN='kinase'
TAXON='rodentia'
MAX_SEQS=50
...
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_9/sequences.fasta'
max_seqs    = 50
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_9/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
php $PHP_DIR/update_job.php $JOB_ID $N_SEQS
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_9/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_9/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_9/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_9/histogram.png'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_9/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_9/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_9/structure.pdb'
else
    update_status pymol Failed
fi

# ---- ALL DONE ----
echo 'JAHbio job 9 complete.'
