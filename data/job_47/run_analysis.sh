...
# run_analysis.sh — JAHbio job 47

JOB_ID=47
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_47
...
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_47/sequences.fasta'
max_seqs    = 10
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_47/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
$DB_UPDATE "UPDATE jobs SET n_returned=$N_SEQS WHERE job_id=$JOB_ID;"
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_47/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_47/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_47/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_47/histogram.png'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_47/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_47/structure.pdb'

rec = next(SeqIO.parse(fasta, 'fasta'))
seq = str(rec.seq)

seq = seq[:400] 
//limiting to 400 (Meta API constraint)
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_47/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 47 complete.'
