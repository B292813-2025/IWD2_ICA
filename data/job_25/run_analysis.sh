...
search_term = 'glucose-6-phosphatase[protein] AND vertebrates[organism]'
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_25/sequences.fasta'
max_seqs    = 50

tax_handle = Entrez.esearch(db='taxonomy', term='vertebrates')
tax_record = Entrez.read(tax_handle)
tax_handle.close()
if tax_record['Count'] == '0':
    print('Taxon not found in NCBI taxonomy: vertebrates')
    sys.exit(1)
