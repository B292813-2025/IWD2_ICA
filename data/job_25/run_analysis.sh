...
# run_analysis.sh — JAHbio job 25

JOB_ID=25
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_25
PROTEIN='kinase'
TAXON='Aves'
MAX_SEQS=50
...
search_term = 'kinase[protein] AND Aves[organism]'
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_25/sequences.fasta'
max_seqs    = 50
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_25/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
php $PHP_DIR/update_job.php $JOB_ID $N_SEQS
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_25/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_25/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_25/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_25/histogram.png'
...
fasta    = '/localdisk/home/s2837201/public_html/ICA/data/job_25/sequences.fasta'
out_file = '/localdisk/home/s2837201/public_html/ICA/data/job_25/motifs.txt'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_25/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_25/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_25/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 25 complete.'
