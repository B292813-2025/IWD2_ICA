...
# run_analysis.sh — JAHbio job 19

JOB_ID=19
BASE=/localdisk/home/s2837201/public_html/ICA/data/job_19
PROTEIN='cox1'
TAXON='Mammalia'
MAX_SEQS=10
...
fasta_out   = '/localdisk/home/s2837201/public_html/ICA/data/job_19/sequences.fasta'
max_seqs    = 10
...
N_SEQS=$(grep -c '^>' "/localdisk/home/s2837201/public_html/ICA/data/job_19/sequences.fasta" 2>/dev/null)
N_SEQS=${N_SEQS:-0}
php $PHP_DIR/update_job.php $JOB_ID $N_SEQS
update_status fetch Complete "/localdisk/home/s2837201/public_html/ICA/data/job_19/sequences.fasta"
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_19/sequences.fasta'
out_png = '/localdisk/home/s2837201/public_html/ICA/data/job_19/histogram.png'
...
PYEOF
update_status histogram Complete '/localdisk/home/s2837201/public_html/ICA/data/job_19/histogram.png'
...
fasta    = '/localdisk/home/s2837201/public_html/ICA/data/job_19/sequences.fasta'
out_file = '/localdisk/home/s2837201/public_html/ICA/data/job_19/motifs.txt'
...
fasta   = '/localdisk/home/s2837201/public_html/ICA/data/job_19/sequences.fasta'
pdb_out = '/localdisk/home/s2837201/public_html/ICA/data/job_19/structure.pdb'
...
PYEOF
if [ $? -eq 0 ]; then
    update_status pymol Complete '/localdisk/home/s2837201/public_html/ICA/data/job_19/structure.pdb'
else
    update_status pymol Failed
fi

echo 'JAHbio job 19 complete.'
